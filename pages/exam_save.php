...
include('../dist/includes/dbcon.php');
	...
	foreach ($third as $daym){
		...
		//fourth day sched
	foreach ($fourth as $daym){
		//check conflict for member
		$query_member=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where member_id='$member' and exam_sched.time_id='$daym' and day='fourth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$row=mysqli_fetch_array($query_member);
			$count_t=$row['count'];
			$time1=date("h:i a",strtotime($row['time_start']))."-".date("h:i a",strtotime($row['time_end']));
			$member1=$row['member_last'].", ".$row['member_first'];
			...
			<table width='100%'>
				<tr>	
					<td style='text-align:left'>$time1</td>
					<td style='text-align:left'>fourth Day</td> 
					<td style='text-align:left'>$member1</td>
					<td class='text-danger' style='text-align:left'><b>Conflict</b></td>					
				</tr>
				</span>
		...
		//check conflict for room
		$query_room=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where room='$room' and exam_sched.time_id='$daym' and day='fourth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$rowr=mysqli_fetch_array($query_room);
			$count_r=$rowr['count'];
			$timer=date("h:i a",strtotime($rowr['time_start']))."-".date("h:i a",strtotime($rowr['time_end']));
			$roomr=$rowr['room'];
			...
			//check conflict for class
		$query_class=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where cys='$cys' and exam_sched.time_id='$daym' and day='fourth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$rowc=mysqli_fetch_array($query_class);
			$count_c=$rowc['count'];
			$cysc=$rowc['cys'];
			$timec=date("h:i a",strtotime($rowc['time_start']))."-".date("h:i a",strtotime($rowc['time_end']));
		...
		{
			mysqli_query($con,"INSERT INTO exam_sched(time_id,day,member_id,subject_code,cys,cys1,room,remarks,settings_id,term,encoded_by) 
				VALUES('$daym','fourth','$member','$subject','$cys','$cys1','$room','$remarks','$set_id','$term','$id')")or die(mysqli_error());
	...
	//-------------------------------------------------------------
	//fifth day sched
	foreach ($fifth as $daym){
		//check conflict for member
		$query_member=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where member_id='$member' and exam_sched.time_id='$daym' and day='fifth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$row=mysqli_fetch_array($query_member);
			$count_t=$row['count'];
			$time1=date("h:i a",strtotime($row['time_start']))."-".date("h:i a",strtotime($row['time_end']));
			$member1=$row['member_last'].", ".$row['member_first'];
			...
			<table width='100%'>
				<tr>	
					<td style='text-align:left'>$time1</td>
					<td style='text-align:left'>fifth Day</td> 
					<td style='text-align:left'>$member1</td>
					<td class='text-danger' style='text-align:left'><b>Conflict</b></td>					
				</tr>
				</span>
		...
		//check conflict for room
		$query_room=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where room='$room' and exam_sched.time_id='$daym' and day='fifth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$rowr=mysqli_fetch_array($query_room);
			$count_r=$rowr['count'];
			$timer=date("h:i a",strtotime($rowr['time_start']))."-".date("h:i a",strtotime($rowr['time_end']));
			$roomr=$rowr['room'];
			...
			//check conflict for class
		$query_class=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where cys='$cys' and exam_sched.time_id='$daym' and day='fifth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$rowc=mysqli_fetch_array($query_class);
			$count_c=$rowc['count'];
			$cysc=$rowc['cys'];
			$timec=date("h:i a",strtotime($rowc['time_start']))."-".date("h:i a",strtotime($rowc['time_end']));
		...
		{
			mysqli_query($con,"INSERT INTO exam_sched(time_id,day,member_id,subject_code,cys,cys1,room,remarks,settings_id,term,encoded_by) 
				VALUES('$daym','fifth','$member','$subject','$cys','$cys1','$room','$remarks','$set_id','$term','$id')")or die(mysqli_error());
	...
	//sixth day sched
	foreach ($sixth as $daym){
		//check conflict for member
		$query_member=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where member_id='$member' and exam_sched.time_id='$daym' and day='sixth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$row=mysqli_fetch_array($query_member);
			$count_t=$row['count'];
			$time1=date("h:i a",strtotime($row['time_start']))."-".date("h:i a",strtotime($row['time_end']));
			$member1=$row['member_last'].", ".$row['member_first'];
			...
			<table width='100%'>
				<tr>	
					<td style='text-align:left'>$time1</td>
					<td style='text-align:left'>sixth Day</td> 
					<td style='text-align:left'>$member1</td>
					<td class='text-danger' style='text-align:left'><b>Conflict</b></td>					
				</tr>
				</span>
		...
		//check conflict for room
		$query_room=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where room='$room' and exam_sched.time_id='$daym' and day='sixth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$rowr=mysqli_fetch_array($query_room);
			$count_r=$rowr['count'];
			$timer=date("h:i a",strtotime($rowr['time_start']))."-".date("h:i a",strtotime($rowr['time_end']));
			$roomr=$rowr['room'];
			...
			//check conflict for class
		$query_class=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where cys='$cys' and exam_sched.time_id='$daym' and day='sixth' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$rowc=mysqli_fetch_array($query_class);
			$count_c=$rowc['count'];
			$cysc=$rowc['cys'];
			$timec=date("h:i a",strtotime($rowc['time_start']))."-".date("h:i a",strtotime($rowc['time_end']));
		...
		{
			mysqli_query($con,"INSERT INTO exam_sched(time_id,day,member_id,subject_code,cys,cys1,room,remarks,settings_id,term,encoded_by) 
				VALUES('$daym','sixth','$member','$subject','$cys','$cys1','$room','$remarks','$set_id','$term','$id')")or die(mysqli_error());
	...
	//seventh day sched
	foreach ($seventh as $daym){
		//check conflict for member
		$query_member=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where member_id='$member' and exam_sched.time_id='$daym' and day='seventh' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$row=mysqli_fetch_array($query_member);
			$count_t=$row['count'];
			$time1=date("h:i a",strtotime($row['time_start']))."-".date("h:i a",strtotime($row['time_end']));
			$member1=$row['member_last'].", ".$row['member_first'];
			...
			<table width='100%'>
				<tr>	
					<td style='text-align:left'>$time1</td>
					<td style='text-align:left'>seventh Day</td> 
					<td style='text-align:left'>$member1</td>
					<td class='text-danger' style='text-align:left'><b>Conflict</b></td>					
				</tr>
				</span>
		...
		//check conflict for room
		$query_room=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where room='$room' and exam_sched.time_id='$daym' and day='seventh' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$rowr=mysqli_fetch_array($query_room);
			$count_r=$rowr['count'];
			$timer=date("h:i a",strtotime($rowr['time_start']))."-".date("h:i a",strtotime($rowr['time_end']));
			$roomr=$rowr['room'];
			...
			//check conflict for class
		$query_class=mysqli_query($con,"select *,COUNT(*) as count from exam_sched 
		natural join member natural join time where cys='$cys' and exam_sched.time_id='$daym' and day='seventh' and settings_id='$sid' and term='$term'")or die(mysqli_error($con));
			$rowc=mysqli_fetch_array($query_class);
			$count_c=$rowc['count'];
			$cysc=$rowc['cys'];
			$timec=date("h:i a",strtotime($rowc['time_start']))."-".date("h:i a",strtotime($rowc['time_end']));
		...
		{
			mysqli_query($con,"INSERT INTO exam_sched(time_id,day,member_id,subject_code,cys,cys1,room,remarks,settings_id,term,encoded_by) 
				VALUES('$daym','seventh','$member','$subject','$cys','$cys1','$room','$remarks','$set_id','$term','$id')")or die(mysqli_error());
