              ...
              <div class="box box-warning">
               <form method="post" id="reg-form">
                <div class="box-body">
					...
					<center><span style="font-size:18px;font-weight:bolder" class="">Print Exam Schedule &nbsp;</span>
<br><div class="btn-group">
					<a href="#examroom" data-target="#examroom" data-toggle="modal" class="dropdown-toggle">
						
                     <button class="button">Room</button>				
                    </a>
					<a href="#examclass" data-target="#examclass" data-toggle="modal" class="dropdown-toggle">
                     
                     <button class="button">Class</button>				
                    </a>
          <a href="#examt" data-target="#examt" data-toggle="modal" class="dropdown-toggle">
