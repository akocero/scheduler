...
<html>
 ...
 <style>
  ...
  <body class="hold-transition skin-Maroon layout-top-nav">
    <div class="wrapper">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" value="CDSGA ADMIN" name="name" placeholder="Full Name" required readonly>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				  <div class="form-group">
