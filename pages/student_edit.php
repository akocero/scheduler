					...
					<div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Last Name</label><br>
								<input type="text" class="form-control" name="last" placeholder="Last Name" value="<?php echo $row['student_last'];?>" required>	
						  </div><!-- /.form group -->
						  <div class="form-group">
							<label for="date">First Name</label><br>
								<input type="text" class="form-control" name="first" placeholder="First Name" value="<?php echo $row['student_first'];?>" required>	
						  </div><!-- /.form group -->
						   <div class="form-group">
							<label for="date">Middle Name</label><br>
								<input type="text" class="form-control" name="mid" placeholder="Middle Name" value="<?php echo $row['student_mid'];?>" >	
						  </div><!-- /.form group -->
						  <div class="form-group">
						   <label for="date">Year Level</label><br>
                <input type="text" class="form-control" name="lvl" placeholder="Year level" 
                value="<?php echo $row['yearlevel'];?>">
                 </div><!-- /.form group --> 
						 	<div class="form-group">
							<label for="date">Program</label>
							
								<select class="form-control select2" name="prog" required>
								  ...
								  ?>
										<option><?php echo $row2['prog_code'];?></option>
								  <?php }
                  ...
                  <div class="form-group">
					  ...
					  <a class="btn btn-lg btn-default " id="daterange-btn" href="student.php">
                       Cancel
                      </a>
