...
<html>
  ...
  <body class="hold-transition skin-Maroon layout-top-nav" onload="myFunction()">
    ...
    <?php
        ...
        $query=mysqli_query($con,"select * from subject natural join settings ORDER BY year")or die(mysqli_error());
		...
		<div class="col-md-6">
            ...
            <div class="col-md-3">
              ...
              <label for="date">Semester</label><br>
                ...
                value="<?php echo $_REQUEST['code'];?>" placeholder="Subject Code">
								<input type="text" class="form-control" id="class" name="title" 
                value="<?php echo $_REQUEST['title'];?>" placeholder="Subject Title" required>
                  <input type="text" class="form-control" id="units" name="units" 
                value="<?php echo $_REQUEST['units'];?>" placeholder="Units">
                <div class="form-group">
              <label for="date">Year</label><br>
                <select class="form-control select2" style="width: 100%;" id="year" name="year" 
                required>
                 <option><?php echo $_REQUEST['year'];?></option>
                  <option>First Year</option>
                  <option>Second Year</option>
                  <option>Third Year</option>
                  <option>Fourth Year</option>
               ...
               <div class="form-group">
              <label for="date">Semester</label><br>
                <select class="form-control select2" style="width: 100%;" id="sem" name="sem" required>
                  <option><?php echo $_REQUEST['sem'];?></option>
                  <option>1st</option>
                  <option>2nd</option>
                </select>
              </div><!-- /.form group -->          
