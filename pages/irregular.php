	      ...
	      <div class="col-md-9">
              <div class="box box-warning">
              	<div style="text-align: center">
              		<h4>Print Irregular Student's Schedule
		...
		<div class="col-md-6">
			...
			?>
								  <tr >
									...
									<td><input type="checkbox" name="sat[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"></td>
									<td><input type="checkbox" name="sun[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"></td>
								  </tr> 
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  <div class="form-group">
							<label for="date">Irregular Student</label>
							
								<select class="form-control select2" name="student" required>
								  <?php 
									$query2=mysqli_query($con,"select * from student where status='irregular' order by student_last")or die(mysqli_error($con));
									  while($row=mysqli_fetch_array($query2)){
								  ?>
										<option value="<?php echo $row['student_id'];?>"><?php echo $row['student_last'].", ".$row['student_first'];?></option>
								  <?php }
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Search Irregular Student's Schedule</h4>
              </div>
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="ireg_sched.php" target="_blank">
                
				<div class="form-group">
					<label class="control-label col-lg-2" for="name">Irregular</label>
					<div class="col-lg-10">
					<select class="select2" name="irregular" style="width:90%!important" required>
								  <?php 
 ...
 <!--end of modal--> 
	<script type="text/javascript">
		...
		$(document).on('submit', '#reg-form', function()
		 {  
		  $.post('submitireg.php', $(this).serialize(), function(data)
		  {
		   $(".result").html(data);  
		   $("#form1")[0].reset();
		  // $("#check").reset();
